...
ref_sys = np.loadtxt("triang_ref.txt", skiprows=1)
#sim_sys = np.loadtxt("triang_sys.txt", skiprows=1)
...
MPI_RANKS = 3
OUT_PFX = "triang_final_" # final coordinates saved as OUT_PFX + coords.txt
NTOMP = 2
